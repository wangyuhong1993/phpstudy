...
export const constantRouterMap = [
  ...
  },
  {
    path: '/deliverManage',
    component: Layout,
    redirect: '/deliverManage/deliverTemplate',
    name: '交付物管理',
    alwaysShow:true,
    meta: { title: '交付物管理', icon: 'example' },
    children: [
      {
        path: 'deliverTemplate',
        name: 'index',
        component: () => import('@/views/deliverManage/index'),
        meta: { title: '交付物模板管理', icon: 'table' }
      }
    ]
  },

  {
    ...
    children: [
      ...
      {
        path: 'projectFunction',
        name: 'projectFunction',
        component: () => import('@/views/projectManage/projectFunction'),
        meta: { title: '项目功能点维护', icon: 'form' }
      }
    ]
  },
